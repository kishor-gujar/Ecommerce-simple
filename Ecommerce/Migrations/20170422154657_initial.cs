        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShppingAddress = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorLLoc = table.Column<string>(nullable: true),
                    ErrorMsg = table.Column<string>(nullable: true),
                    Fulfilled = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Availabel = table.Column<bool>(nullable: false, defaultValue: true),
                    AvailabelSize = table.Column<int>(nullable: false),
                    CategoryId = table.Column<int>(nullable: false),
                    Color = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: false),
                    Dicount = table.Column<decimal>(nullable: false),
                    DiscountAvailabel = table.Column<float>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    Note = table.Column<string>(nullable: true),
                    Picture = table.Column<string>(nullable: false),
                    QuantityPerUnit = table.Column<int>(nullable: false),
                    Ranking = table.Column<int>(nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fulfiled = table.Column<string>(nullable: true),
